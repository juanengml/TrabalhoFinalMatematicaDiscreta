...
Deve conter: * Uma breve descrição do objetivo do trabalho * O que são
algoritmos de ordenação, o que fazem, como funcionam, onde podem ser
aplicados, importância etc * Uma breve introdução aos algoritmos
escolhidos
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}68}]:} \PY{k}{def} \PY{n+nf}{merge}\PY{p}{(}\PY{n}{llist}\PY{p}{,} \PY{n}{rlist}\PY{p}{)}\PY{p}{:}
         ...
         \PY{l+s+sd}{        Sort the list passed by argument with merge.}
         \PY{l+s+sd}{        \PYZdq{}\PYZdq{}\PYZdq{}}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}72}]:} \PY{n}{data01} \PY{o}{=} \PY{p}{[}\PY{p}{]}
         \PY{k}{for} \PY{n}{p} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{l+m+mi}{10}\PY{p}{)}\PY{p}{:}
          \PY{n}{ini01} \PY{o}{=} \PY{n}{time}\PY{o}{.}\PY{n}{time}\PY{p}{(}\PY{p}{)}
          \PY{n}{merge\PYZus{}sort}\PY{p}{(}\PY{p}{[}\PY{l+m+mi}{5}\PY{p}{,}\PY{l+m+mi}{3}\PY{p}{,}\PY{l+m+mi}{1}\PY{p}{,}\PY{l+m+mi}{7}\PY{p}{,}\PY{l+m+mi}{2}\PY{p}{,}\PY{l+m+mi}{9}\PY{p}{,}\PY{l+m+mi}{8}\PY{p}{]}\PY{p}{)}
          \PY{n}{fim01} \PY{o}{=} \PY{n}{time}\PY{o}{.}\PY{n}{time}\PY{p}{(}\PY{p}{)}
          \PY{k}{print} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Tempo de Execução: }\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{fim01}\PY{o}{\PYZhy{}}\PY{n}{ini01}
          \PY{n}{tempo01} \PY{o}{=} \PY{n}{fim01}\PY{o}{\PYZhy{}}\PY{n}{ini01}
          \PY{n}{data01}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{tempo01}\PY{p}{)}
\end{Verbatim}
...
pseudocódigo * Citações para a descrição do algoritmo e pseudocódigo
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}66}]:} \PY{k}{def} \PY{n+nf}{bubble\PYZus{}sort}\PY{p}{(}\PY{n}{lista}\PY{p}{)}\PY{p}{:}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}71}]:} \PY{n}{data02} \PY{o}{=} \PY{p}{[}\PY{p}{]}
         
         \PY{k}{for} \PY{n}{p} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{l+m+mi}{10}\PY{p}{)}\PY{p}{:}
          \PY{n}{ini} \PY{o}{=} \PY{n}{time}\PY{o}{.}\PY{n}{time}\PY{p}{(}\PY{p}{)}
          \PY{n}{bubble\PYZus{}sort}\PY{p}{(}\PY{p}{[}\PY{l+m+mi}{5}\PY{p}{,}\PY{l+m+mi}{3}\PY{p}{,}\PY{l+m+mi}{1}\PY{p}{,}\PY{l+m+mi}{7}\PY{p}{,}\PY{l+m+mi}{2}\PY{p}{,}\PY{l+m+mi}{9}\PY{p}{,}\PY{l+m+mi}{8}\PY{p}{]}\PY{p}{)}
          \PY{n}{fim} \PY{o}{=} \PY{n}{time}\PY{o}{.}\PY{n}{time}\PY{p}{(}\PY{p}{)}
          \PY{k}{print} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Tempo de Execução: }\PY{l+s+s2}{\PYZdq{}}\PY{p}{,}\PY{n}{fim}\PY{o}{\PYZhy{}}\PY{n}{ini}
          \PY{n}{tempo2} \PY{o}{=} \PY{n}{fim}\PY{o}{\PYZhy{}}\PY{n}{ini} 
          \PY{n}{data02}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{tempo2}\PY{p}{)}
\end{Verbatim}
...
Tempo de Execução:  5.96046447754e-06
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}73}]:} \PY{k}{print} \PY{n}{data02}
         \PY{k}{print} \PY{n}{data01}
\end{Verbatim}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}74}]:} \PY{n}{plt}\PY{o}{.}\PY{n}{plot}\PY{p}{(}\PY{n}{data01}\PY{p}{)}
...
sort}\label{plot-grafico-de-desempenho-bubble-sort}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}75}]:} \PY{n}{plt}\PY{o}{.}\PY{n}{plot}\PY{p}{(}\PY{n}{data02}\PY{p}{)}
